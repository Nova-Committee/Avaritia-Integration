...
public class GenIntegrationBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<InfinitySolarGeneratorBlockEntity, Generator<InfinitySolarGeneratorBlockEntity>>, ItemBlockTooltip<BlockTileModel<InfinitySolarGeneratorBlockEntity, Generator<InfinitySolarGeneratorBlockEntity>>>> INFINITY_SOLAR_GENERATOR = BLOCKS
            .registerDetails("infinity_solar_generator",
                    () -> new BlockTileModel<>(GenIntegrationBlockTypes.INFINITY_SOLAR_GENERATOR,
            ...
            .forItemHolder(holder -> holder.addAttachmentOnlyContainers(ContainerType.ITEM,
                    () -> ItemSlotsBuilder.builder().addEnergy().build()));

    public static final BlockRegistryObject<BlockTileModel<NeutronSolarGeneratorBlockEntity, Generator<NeutronSolarGeneratorBlockEntity>>, ItemBlockTooltip<BlockTileModel<NeutronSolarGeneratorBlockEntity, Generator<NeutronSolarGeneratorBlockEntity>>>> NEUTRON_SOLAR_GENERATOR = BLOCKS
            .registerDetails("neutron_solar_generator",
                    () -> new BlockTileModel<>(GenIntegrationBlockTypes.NEUTRON_SOLAR_GENERATOR,
                            properties -> properties.mapColor(MapColor.COLOR_BLUE)))
            .forItemHolder(holder -> holder.addAttachmentOnlyContainers(ContainerType.ITEM,
                    () -> ItemSlotsBuilder.builder().addEnergy().build()));

    public static final BlockRegistryObject<BlockTileModel<InfinityAdvancedSolarGeneratorBlockEntity, Generator<InfinityAdvancedSolarGeneratorBlockEntity>>, ItemBlockTooltip<BlockTileModel<InfinityAdvancedSolarGeneratorBlockEntity, Generator<InfinityAdvancedSolarGeneratorBlockEntity>>>> INFINITY_ADVANCED_SOLAR_GENERATOR = BLOCKS
            .registerDetails("infinity_advanced_solar_generator",
                    () -> new BlockTileModel<>(GenIntegrationBlockTypes.INFINITY_ADVANCED_SOLAR_GENERATOR,
                            properties -> properties.mapColor(MapColor.COLOR_BLUE)))
            .forItemHolder(holder -> holder.addAttachmentOnlyContainers(ContainerType.ITEM,
                    () -> ItemSlotsBuilder.builder().addEnergy().build()));

    public static final BlockRegistryObject<BlockTileModel<NeutronAdvancedSolarGeneratorBlockEntity, Generator<NeutronAdvancedSolarGeneratorBlockEntity>>, ItemBlockTooltip<BlockTileModel<NeutronAdvancedSolarGeneratorBlockEntity, Generator<NeutronAdvancedSolarGeneratorBlockEntity>>>> NEUTRON_ADVANCED_SOLAR_GENERATOR = BLOCKS
            .registerDetails("neutron_advanced_solar_generator",
                    () -> new BlockTileModel<>(GenIntegrationBlockTypes.NEUTRON_ADVANCED_SOLAR_GENERATOR,
                            properties -> properties.mapColor(MapColor.COLOR_BLUE)))
            .forItemHolder(holder -> holder.addAttachmentOnlyContainers(ContainerType.ITEM,
                    () -> ItemSlotsBuilder.builder().addEnergy().build()));
}
