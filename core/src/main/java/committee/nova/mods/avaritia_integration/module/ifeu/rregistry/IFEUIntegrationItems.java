            ...
            .register("energy_addon_crystal_matrix", () -> new EnergyAddonItem(8, IFEUItems.TAB_ADDONS) {
                ...
                public void registerRecipe(RecipeOutput recipeOutput) {
                    dissolutionChamberRecipe(this.getDefaultInstance(), List.of(
                            ...
                            itemValue(AIItems.CRYSTAL_MATRIX_GEAR.get().getDefaultInstance())),
                            new FluidStack(IndustrialForegoingIntegrationFluids.ELDERLY_MEDULLA.getSourceFluid(), 1000),
                            200, recipeOutput);
                }
            });
            ...
            () -> new EnergyAddonItem(9, IFEUItems.TAB_ADDONS) {
                ...
                public void registerRecipe(RecipeOutput recipeOutput) {
                    dissolutionChamberRecipe(this.getDefaultInstance(), List.of(
                            ...
                            itemValue(ModItems.neutron_gear.get().getDefaultInstance())),
                            new FluidStack(IndustrialForegoingIntegrationFluids.VOID_MATTER.getSourceFluid(), 1000),
                            300, recipeOutput);
                }
            });
            ...
            () -> new EnergyAddonItem(10, IFEUItems.TAB_ADDONS) {
                ...
                public void registerRecipe(RecipeOutput recipeOutput) {
                    dissolutionChamberRecipe(this.getDefaultInstance(), List.of(
                            ...
                            itemValue(AIItems.INFINITY_GEAR.get().getDefaultInstance())),
                            new FluidStack(IndustrialForegoingIntegrationFluids.ELDERLY_MEDULLA.getSourceFluid(), 2000),
                            400, recipeOutput);
                }
            });

    public static DeferredHolder<Item, EnergyAddonItem> registerEnergyAddon(String prefix,
                                                                            DeferredHolder<Item, Item> input,
                                                                            Supplier<DeferredHolder<Fluid, Fluid>> fluid,
                                                                            int amount, int processingTime) {
        return ITEMS.register("energy_addon_" + prefix, () -> new EnergyAddonItem(7, ModuleCore.TAB_CORE) {
            ...
            public void registerRecipe(RecipeOutput recipeOutput) {
                dissolutionChamberRecipe(this.getDefaultInstance(), List.of(
                        ...
                        itemValue(input.get().getDefaultInstance())), new FluidStack(fluid.get(), amount),
                        processingTime, recipeOutput);
            }
        });
    }
