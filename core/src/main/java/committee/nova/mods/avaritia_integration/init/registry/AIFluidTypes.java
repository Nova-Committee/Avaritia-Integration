...
public class AIFluidTypes {
    ...
    public static final DeferredHolder<FluidType, FluidType> molten_crystal_matrix = REGISTRY
            .register("molten_crystal_matrix",
                    () -> new BaseFluidType("molten_crystal_matrix",
                            new Vector3f(103f / 225f, 187f / 225f, 182f / 255f),
    ...
    private static FluidType.Properties base(String name) {
        return FluidType.Properties.create().viscosity(10000).density(2000)
                .descriptionId("fluid.avaritia_integration." + name)
                .sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
                .sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY).canSwim(false).canDrown(false)
