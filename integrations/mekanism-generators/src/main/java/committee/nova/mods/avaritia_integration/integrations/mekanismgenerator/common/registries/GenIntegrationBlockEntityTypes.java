...
public class GenIntegrationBlockEntityTypes {
    ...
    public static final TileEntityTypeRegistryObject<InfinitySolarGeneratorBlockEntity> INFINITY_SOLAR_GENERATOR = TILE_ENTITY_TYPES
            .mekBuilder(GenIntegrationBlocks.INFINITY_SOLAR_GENERATOR, InfinitySolarGeneratorBlockEntity::new)
            .clientTicker(TileEntityMekanism::tickClient)
            .serverTicker(TileEntityMekanism::tickServer)
            .withSimple(Capabilities.CONFIG_CARD)
            .build();
    public static final TileEntityTypeRegistryObject<NeutronSolarGeneratorBlockEntity> NEUTRON_SOLAR_GENERATOR = TILE_ENTITY_TYPES
            .mekBuilder(GenIntegrationBlocks.NEUTRON_SOLAR_GENERATOR, NeutronSolarGeneratorBlockEntity::new)
            .clientTicker(TileEntityMekanism::tickClient)
            .serverTicker(TileEntityMekanism::tickServer)
            .withSimple(Capabilities.CONFIG_CARD)
            .build();
    public static final TileEntityTypeRegistryObject<InfinityAdvancedSolarGeneratorBlockEntity> INFINITY_ADVANCED_SOLAR_GENERATOR = TILE_ENTITY_TYPES
            .mekBuilder(GenIntegrationBlocks.INFINITY_ADVANCED_SOLAR_GENERATOR,
                    InfinityAdvancedSolarGeneratorBlockEntity::new)
            .clientTicker(TileEntityMekanism::tickClient)
            .serverTicker(TileEntityMekanism::tickServer)
            .withSimple(Capabilities.CONFIG_CARD)
    ...
    public static final TileEntityTypeRegistryObject<NeutronAdvancedSolarGeneratorBlockEntity> NEUTRON_ADVANCED_SOLAR_GENERATOR = TILE_ENTITY_TYPES
            .mekBuilder(GenIntegrationBlocks.NEUTRON_ADVANCED_SOLAR_GENERATOR,
                    NeutronAdvancedSolarGeneratorBlockEntity::new)
            .clientTicker(TileEntityMekanism::tickClient)
            .serverTicker(TileEntityMekanism::tickServer)
            .withSimple(Capabilities.CONFIG_CARD)
            .withSimple(Capabilities.EVAPORATION_SOLAR)
