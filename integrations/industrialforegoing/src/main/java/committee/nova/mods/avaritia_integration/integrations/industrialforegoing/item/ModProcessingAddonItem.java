...
public class ModProcessingAddonItem extends AddonItem {
    ...
    public @NotNull String getDescriptionId() {
        ...
        return addon + Component.translatable("item.industrialforegoing.processing").getString() + "Tier " +
    ...
    public void addTooltipDetails(@Nullable BasicItem.Key key, ItemStack stack, List<Component> tooltip,
        ...
        tooltip.add(Component.translatable("item.industrialforegoing.processing").append("x" + upgrade)
