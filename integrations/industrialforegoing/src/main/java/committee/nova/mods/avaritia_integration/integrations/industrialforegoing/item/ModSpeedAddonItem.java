...
public class ModSpeedAddonItem extends AddonItem {
    ...
    public @NotNull String getDescriptionId() {
        ...
        return addon + Component.translatable("item.industrialforegoing.speed").getString() + "Tier " +
    ...
    public void addTooltipDetails(@Nullable BasicItem.Key key, ItemStack stack, List<Component> tooltip,
        ...
        tooltip.add(Component.translatable("tooltip.avaritia_integration.cooldown_time")
                .append(": " + Math.ceil(reduction) + "%").withStyle(ChatFormatting.GRAY));
    }
}
